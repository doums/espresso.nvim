...
li('TSTag', 'Keyword')
hi('TSTagAttribute', p.fg, nil, 'italic')
...
hi('DiagnosticSignError', p.errorStripe, nil, 'bold')
li('DiagnosticSignWarn', 'WarningSign')
li('DiagnosticSignInfo', 'InformationSign')
li('DiagnosticSignHint', 'HintSign')
li('DiagnosticUnderlineError', 'Error')
li('DiagnosticUnderlineWarn', 'Warning')
li('DiagnosticUnderlineInfo', 'Information')
li('DiagnosticUnderlineHint', 'Hint')
