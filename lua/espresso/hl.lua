...
function M.init()
  ...
  hl('Hint', p.hint)
  hl('ErrorUnderline', nil, nil, 'underdashed', p.errorEffect)
  hl('WarnUnderline', nil, p.warning, 'underdashed', p.warnEffect)
